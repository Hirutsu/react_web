...
const MainSlider = (mainTitle) => {
  ...
  return (
    <div className="slider">
      {pageOffset == 0 ? null : (
        <div className="slider__arrow-prev" onClick={() => prevSlide()}></div>
      )}
        ...
        >
          <div className="slider__item slider__item_green active">
            <button
              ...
              className="green-button slider__button"
            >
              explore
            </button>
          </div>
      ...
      {pageOffset == -(sliderWidth * slidesNumber) ? null : (
        <div className="slider__arrow-next" onClick={() => nextSlide()}></div>
      )}
    </div>
  );
};
