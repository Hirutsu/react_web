...
const SneakersItem = (props) => {
  ...
  const favoriteArray = useSelector(
    ({ favoriteItems }) => favoriteItems.favorites
  );
  ...
  return (
    <li className="sneakers-item">
      {props.isOrdered ? null : (
        <button
          type="button"
          className="sneakers-item__favorites"
          onClick={() => {
            addedToFavorites
        ...
        >
          <div
            className={`favorite-wrapper ${
              addedToFavorites || props.isFavorite ? "added" : ""
            }`}
          >
            <svg
              width="32"
      ...
      <h2 className="sneakers-item__title">{props.name}</h2>
      <div className="sneakers-item__info">
        ...
        {props.isOrdered ? null : (
          <button
            type="button"
            className="sneakers-item__order"
            onClick={() => {
              addedToCart ? removeItemFromCart(id) : addItemToCart(props);
            }}
          >
            <div
              className={`add-to-cart-wrapper ${
                cartContainsObj() == true && addedToCart == true ? "added" : ""
              }`}
            >
              <img
                src="/react-sneakers/img/add-to-cart.jpg"
                alt="add to cart"
                className="add-to-cart-unadded"
              />
              <img
                src="/react-sneakers/img/added-to-cart.jpg"
                alt="added to cart"
