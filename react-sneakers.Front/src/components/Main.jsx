  ...
  return (
    <main className="main">
      <div className="container">
        ...
        <div className="main__title__wrapper">
          ...
          <div className="main__title__search">
            ...
            <img
              ...
              alt="search"
              src="/react-sneakers/img/search.png"
            />
            {searchValue && (
              <svg
                width="25"
              ...
              >
                <path
                  d="M19.6946 6.55359L18.2846 5.14359L12.6946 10.7336L7.10464 5.14359L5.69464 6.55359L11.2846 12.1436L5.69464 17.7336L7.10464 19.1436L12.6946 13.5536L18.2846 19.1436L19.6946 17.7336L14.1046 12.1436L19.6946 6.55359Z"
                  fill="black"
                />
              </svg>
            )}
        ...
        <ul className="sneakers-list">{sneakersItems}</ul>
      </div>
    </main>
  );
};
